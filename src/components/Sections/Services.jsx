	...
	return (
		<Wrapper id="services">
			...
			<div className="whiteBg" style={{ padding: "60px 0" }}>
				<div className="container">
					<HeaderInfo>
						<h1 className="font40 extraBold">Our Helpful Service</h1>
						<p className="font13">
							...
							<br />
							Our platform can be used in PCOD/PCOS cases and can impact lives of
							several young girls.
						</p>
					</HeaderInfo>
						...
						<Advertising className="flexSpaceCenter">
							<AddLeft>
								...
								<p className="font12">
									...
									and hygiene. Here at Gynoglance we respect privacy so you can opt
